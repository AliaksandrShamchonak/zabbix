...
#
## Zabbix JavaGateway Server Part:
## Modify /ets/zabbix/zabbix_server.conf:
## 288 # Option: JavaGateway # JavaGateway=IP_ADDR_of_Zabbix_Java_GW
#sed -i 's/^# JavaGateway=zabbix/JavaGateway=127.0.0.1/' /etc/zabbix/zabbix_server.conf
## 296 # Option: JavaGatewayPort # JavaGatewayPort=10052
#sed -i 's/^# JavaGatewayPort=/JavaGatewayPort=/' /etc/zabbix/zabbix_server.conf
#### Option: StartJavaPollers # StartJavaPollers=5
